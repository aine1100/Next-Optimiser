...
import { Project, SyntaxKind, ParameterDeclaration, VariableDeclaration, FunctionDeclaration, ArrowFunction } from 'ts-morph';
          ...
          if (isInsideJsx) {
            ...
            if (callback && (callback.getKind() === SyntaxKind.ArrowFunction || callback.getKind() === SyntaxKind.FunctionExpression)) {
              ...
              if (indexParam) {
                ...
                const keyAttr = body.getDescendantsOfKind(SyntaxKind.JsxAttribute).find((a: any) => {
